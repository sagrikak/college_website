...
<center>
<h3> Your Profile </h3>
<table style="border-collapse: collapse; font: 20px Merienda; color:white" cellspacing="5" cellpadding="15" border="0">
	<tbody>
		<tr>
			<td>
				Profile Picture:
		...
		<tr>
			...
			<td>
				<?php echo $details[0]['course'] ?>
			</td>
		</tr>
		<tr>
			<td>
				<?php if(!empty($details[0]['course2'])) echo 'Course ID:' ?>
			</td>
			<td>
				<?php if(!empty($details[0]['course2'])) echo $details[0]['course2'] ?>
			</td>
		</tr>
	</tbody>
</table>
