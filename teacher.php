...
<div class="container" style="background-color: #333;
	...
	font-size: 25px; color: white">
		...
		<a href="teacher_files/teacher_view_profile.php">View Profile</a><br><br>
		<a href="teacher_files/teacher_edit_profile.php">Edit Profile</a><br><br>
		<a href="teacher_files/mark_attendance.php">Mark Attendance</a><br><br>
		<a href="teacher_files/mark_leave.php">Mark Leave</a><br><br>
		<a href="teacher_files/view_attendance.php">View Attendance</a><br><br>
		<a href="teacher_files/send_email.php">Send Email</a><br>
